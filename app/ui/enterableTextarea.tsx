...
export default function EnterableTextarea({className = '', autoFocus, value = '', onChange, onEnter, placeholder = ''}:{
    className:string,
    autoFocus?:boolean,
    value:string, 
    onChange:(e: React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>)=>void, onEnter:()=>void,
    placeholder:string}
) {
